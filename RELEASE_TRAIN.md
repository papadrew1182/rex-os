...
- Latest unattended rerun (2026-05-18 10:52Z): architecture/static gates revalidated green (backend pytest subset, frontend `test:unit:api-base`, lint, build, migration-sanity override).
