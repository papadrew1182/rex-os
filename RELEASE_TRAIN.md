...
- Latest unattended rerun (2026-05-18 11:10Z): architecture/static gates revalidated green (backend pytest subset, frontend `test:unit:api-base`, frontend SSE unit tests, lint, build, migration-sanity override); frontend reliability hardening added hidden sourcemap generation for Sentry symbolication readiness.
